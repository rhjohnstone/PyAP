...
best_fit_final_state_vars_file = ps.cmaes_final_state_vars_file(pyap_options["model_number"], expt_name, trace_name)
best_fit_final_state_vars = ap_model.GetStateVariables()
print "Best fit final state vars:\n", best_fit_final_state_vars
np.savetxt(best_fit_final_state_vars_file, best_fit_final_state_vars)
