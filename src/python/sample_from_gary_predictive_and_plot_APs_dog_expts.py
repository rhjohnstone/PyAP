...
sns.swarmplot(x="Experiment", y="APD90 (ms)", palette=("blue","red"), data=expt_df, ax=ax1, linewidth=1)#, hue="colours")
sns.violinplot(x="Predictions", y="APD90 (ms)", data=pred_df, palette=("blue","red"), ax=ax2)#, hue="colours")
ax2.set_ylabel("")
