...
for i in xrange(num_gs):
    ...
    ax.set_ylabel("Normalised frequency")
    ax2.set_ylabel("Top normalised frequency")
    ...
    for n in xrange(N_e):
        ...
        ax.hist(chain[:, idx], normed=True, bins=40, color=colour, edgecolor=None, alpha=1.5/N_e)
        ax.axvline(expt_params[n, i], color='red', lw=2)
