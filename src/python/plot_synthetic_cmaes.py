...
best_ap.legend()
best_bar.yaxis.grid()
best_bar.axhline(100, color='red', lw=2)
...
fig.tight_layout()
fig.savefig('m_{}_s_{}_cmaes_its.png'.format(args.model, args.seed))
fig.savefig('m_{}_s_{}_cmaes_its.pdf'.format(args.model, args.seed))
#plt.show(block=True)
plt.close()
